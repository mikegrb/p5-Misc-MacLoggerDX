...
know how to run a L<perl|https://www.perl.org/about.html> script.

=head2 send-qsls.pl

This script uploads QSL entries with empty QSL Sent columns to
L<eQSL|http://eqsl.com> and L<QRZ.com|http://www.qrz.com>.
Entries can easily be sent to L<LoTW|https://lotw.arrl.org/> from the
QRZ site after they are imported there. After running, reload your DB by
selecting File -> Recent -> Your Current Log in MacLoggerDX.
